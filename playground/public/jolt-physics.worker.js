...
const onWorker = async (Jolt, args) => {
	...
	contactListener.OnContactAdded = (...args) => { console.log(args) };
	contactListener.OnContactPersisted = (body1, body2, manifold, settings) => {};
	contactListener.OnContactRemoved = (subShapePair) => {};
	contactListener.OnContactValidate = (body1, body2, baseOffset, collideShapeResult) => { return Jolt.ValidateResult_AcceptAllContactsForThisBodyPair; };
}
