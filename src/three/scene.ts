...
class Sky {
	...
	constructor(protected parent: Three.Object3D) {
	...
	protected _skyDirLight: Three.DirectionalLight = new Three.DirectionalLight(
		0xffffff,
		5,
	);

	protected _skyHemiLight: Three.HemisphereLight = new Three.HemisphereLight(
		0xffffff,
		0x444444,
	);
