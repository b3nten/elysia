export function toBoolean(val: any): boolean { return val ? val !== "false" : false; }
 ...
 * @param callback
 */
export const tick = <T>(callback?: T): T extends Function ? void : Promise<void> =>
{
	if (callback)
	{
		// @ts-ignore
		return (requestAnimationFrame(() => requestAnimationFrame(callback as any))) as unknown as void;
	}
	// @ts-ignore
	return new Promise(resolve => requestAnimationFrame(() => requestAnimationFrame(resolve))) as unknown as Promise<void>;
}
