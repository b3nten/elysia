...
export class PerspectiveCamera extends ThreeObject<Three.PerspectiveCamera> {
	 ...
	 */
	get focus(): number {
		return this.object3d.focus;
	}
	set focus(focus: number) {
		this.object3d.focus = focus;
	}
	...
	get filmGauge(): number {
		return this.object3d.filmGauge;
	}
	set filmGauge(filmGauge: number) {
		this.object3d.filmGauge = filmGauge;
	}
	...
	get filmOffset(): number {
		return this.object3d.filmOffset;
	}
	set filmOffset(filmOffset: number) {
		this.object3d.filmOffset = filmOffset;
	}

	/**
	 * The view of the camera.
	 */
	get view(): Three.PerspectiveCamera["view"] {
		return this.object3d.view;
	}
	set view(view: any) {
		this.object3d.view = view;
	}
