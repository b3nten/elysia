...
{
	static Box(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(box, color);
	}

	static Sphere(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(sphere, color);
	}

	static Cone(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(cone, color);
	}

	static Cylinder(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(cylinder, color);
	}

	static Torus(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(torus, color);
	}

	static Plane(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
		return new PrimitiveMesh(plane, color);
	}

	static Ring(color?: Three.ColorRepresentation | Three.Material): PrimitiveMesh
	{
