...
export class OrthographicCamera extends ThreeObject<Three.OrthographicCamera> {
	override object3d: Three.OrthographicCamera = new Three.OrthographicCamera(
		-1,
		1,
		1,
		-1,
