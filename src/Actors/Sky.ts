...
export class Sky extends ThreeObject<SkyImpl> {
	...
	public readonly skyLight: Three.HemisphereLight = new Three.HemisphereLight(
		0xffffff,
		0x444444,
	);
	...
	private get sky() {
		return this.object3d as SkyImpl;
	}
	private get material() {
		return this.sky.material as Three.ShaderMaterial;
	}
