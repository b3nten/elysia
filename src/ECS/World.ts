...
export class World implements IDestroyable {
	...
	public get components(): AutoInitializedMap<
	...
	public addSystem<T extends System, Args extends any[]>(
		system: Constructor<T, [World, ...Args]>,
		...args: Args
	): T {
	...
	public addEntity(): Entity {
		...
		for (const system of this.#systems) {
			if (system.active) system[Internal.onEntityAdded](entity);
		}
		return entity;
	}
	...
	public removeEntity(entity: Entity) {
		...
		for (const system of this.#systems) {
			if (system.active) system[Internal.onEntityRemoved](entity);
		}
	}
	...
	public addComponent(entity: Entity, component: Component): boolean {
		...
		for (const system of this.#systems) {
			if (system.active) system[Internal.onComponentAdded](entity, component);
		}
	 ...
	 * @param componentType
	 */
	public *iterateByComponent<T extends Component>(
		componentType: Constructor<T>,
	): Generator<[entity: number, component: T], void, unknown> {
		try {
	...
	#components: AutoInitializedMap<
		Constructor<Component>,
		SparseSet<Component>
	> = new AutoInitializedMap<Constructor<Component>, SparseSet<Component>>(
		SparseSet,
	);
}
